...
{
    public partial class milkratestuff : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PieceType = table.Column<string>(nullable: true),
                    ...
                    LastSale = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPiece", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPiece_Piece_PieceId",
                        column: x => x.PieceId,
                        principalTable: "Piece",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPiece_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPiece_PieceId",
                table: "UserPiece",
                column: "PieceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPiece_UserId",
                table: "UserPiece",
                column: "UserId");
        }
